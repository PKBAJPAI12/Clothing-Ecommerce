...
<div class="loginsection">
    <div class="rightlogin">
        ...
        <form style="width: 75%;" action="RegisterServlet" method="post">
            ...
            <h3 style="margin-top: 1.5rem;">Please <a style="text-decoration:none; " href="login.jsp"><strong style="color:red">Login Now!</strong></a> If you have Already Account</h3></a>
        </form>
