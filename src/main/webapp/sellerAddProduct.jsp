      ...
      <form style="width: 90%;" action="AddProductServlet" method="post" enctype="multipart/form-data">
        <div class="formrows">
          <div style="width: 90%; margin: auto;" class="formcol">
            ...
            <input style="color:white;padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="product_name" type="text" class="form-control" placeholder="Enter Product Name">
          </div>
        </div>
        <div class="formrows">
          ...
          <div style="width: 90%; margin: auto;" class="formcol">
            ...
            <textarea style="color:white;padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="product_desc" id="" cols="30" rows="10" class="form-control" placeholder="Enter Product Description"></textarea>
        ...
        <div class="formrows" style="display: flex;">
          ...
          <div style="width: 40%; margin: auto;" class="formcol">
            ...
            <input style="color:white;padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="product_qty" type="number" class="form-control" placeholder="Enter Product Quantity">
          </div>
          ...
          <div style="width: 40%; margin: auto;" class="formcol">
            ...
            <input style="color:white;padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="product_price" type="number" class="form-control" placeholder="Enter Price">
          </div>
        ...
        <div class="formrows" style="display: flex">
          <div style="width: 40%; margin: auto;" class="formcol">
            ...
            <input type="file" style="color:white;padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="product_image"  class="form-control" required/>
          ...
          <div style="width: 40%; margin: auto;" class="formcol">
            ...
            <input style="color:white;padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="discount" type="number" class="form-control" placeholder="Discount">
        ...
        <div class="formrows" style="margin-bottom: 1rem">
          <div style="width: 90%; margin: auto;" class="formcol">
            ...
            <select style="color:white;padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="product_category" id="product_category">
              <option style="background-color: black" value="derc">Casual</option>
              <option style="background-color: black" value="uhbvn">Sports</option>
              <option style="background-color: black" value="dhbvn">Formal</option>
        ...
        <div class="formrows" style="margin-bottom: 1rem">
          <div style="width: 90%; margin: auto;" class="formcol">
            ...
            <select style="color:white;padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="collection_type">
              <option style="background-color: black" value="derc">Mens</option>
              <option style="background-color: black" value="uhbvn">Womens</option>
              <option style="background-color: black" value="dhbvn">Kids</option>
