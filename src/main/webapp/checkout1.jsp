...
<%
    ...
    AddressDao ad = new AddressDao(FactoryProvider.getFactory());
   List<Address> list= ad.getAddressListByUserId(user.getUserId());
...
<div style="margin-top:1.5rem ; margin-left: 0rem; margin-right: 1.5rem; flex-direction: column;"  class="section">
    ...
    <div style=" display:flex; width:100%">
        ...
        <div class="cart-body" style="width:30%; background-color:white; margin-right: 2rem; border-radius: 2rem; border-top:2px solid black; border-left:1px solid black;">
