...
<html>
<head>
    <title>Seller Login-Supreme Clothing</title>
...
<div class="loginsection">
    <div class="rightlogin">
        ...
        <div style="display: flex; margin-bottom: 1.5rem;" class="head1">
            ...
            <h1 style="font-size:1.9rem; margin:auto">Seller Login</h1>
        </div>

        <%@include file="message.jsp"%>

        <form style="width: 75%;" action="SellerLoginServlet" method="post">
            <div class="formcol">
                <div class="formlevel">
